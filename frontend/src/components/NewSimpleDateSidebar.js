...
const NewSimpleDateSidebar = ({ onDocumentSelect = () => {}, selectedDateKey = null }) => {
                  ...
                  >
                    {item.children && Object.keys(item.children).length > 0 && (
                      <span
                        ...
                        onKeyDown={(e) => e.key === 'Enter' && handleArrowClick(item.key)}
                        role="button"
                        tabIndex={0}
                        style={{
                          marginRight: '8px',
                      ...
                      {Object.values(item.children)
                        ...
                        .map((child) => (
                          <div
                            ...
                            onKeyDown={(e) => e.key === 'Enter' && handleItemClick(child.key)}
                            role="button"
                            tabIndex={0}
                            style={{
                              display: 'flex',
